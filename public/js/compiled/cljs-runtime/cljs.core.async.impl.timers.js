...
var i_21030 = (self__.level + (1));
while(true){
if((i_21030 <= (new_level + (1)))){
(update[i_21030] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_21034 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_21034[i]));
} else {
x__$2.forward.push((((i < links_21034.length))?(links_21034[i]):null));
}

if((i < links_21034.length)){
(links_21034[i] = x__$2);
} else {
links_21034.push(x__$2);
}
...
var i_21041 = (0);
while(true){
if((i_21041 <= self__.level)){
var links_21042 = (update[i_21041]).forward;
if((x__$1 === (((i_21041 < links_21042.length))?(links_21042[i_21041]):null))){
(links_21042[i_21041] = (x__$1.forward[i_21041]));

var G__21043 = (i_21041 + (1));
i_21041 = G__21043;
continue;
} else {
var G__21045 = (i_21041 + (1));
i_21041 = G__21045;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__21059 = nx;
var G__21060 = (level__$1 - (1));
x = G__21059;
level__$1 = G__21060;
continue;
} else {
var G__21061 = x;
var G__21062 = (level__$1 - (1));
x = G__21061;
level__$1 = G__21062;
continue;
}
