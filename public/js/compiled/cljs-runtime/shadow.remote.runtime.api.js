...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_20949 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_20949(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_20956 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_20956(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_20960 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_20960(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_20962 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_20962(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_20968 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_20968(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_20971 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_20971(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__20944,callback){
var map__20945 = p__20944;
var map__20945__$1 = cljs.core.__destructure_map(map__20945);
var input = map__20945__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20945__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20945__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
