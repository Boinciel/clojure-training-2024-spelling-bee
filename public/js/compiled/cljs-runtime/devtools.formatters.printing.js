...
var len__5726__auto___16609 = arguments.length;
var i__5727__auto___16610 = (0);
while(true){
if((i__5727__auto___16610 < len__5726__auto___16609)){
args__5732__auto__.push((arguments[i__5727__auto___16610]));

var G__16611 = (i__5727__auto___16610 + (1));
i__5727__auto___16610 = G__16611;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq16550){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16551,G__16552,seq16550__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__16572_SHARP_){
return (!((cljs.core.meta(p1__16572_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16593__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e16594){var _e__14993__auto__ = e16594;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e16597){var _e__14993__auto__ = e16597;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__16599 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__16600 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__16600);

try{var map__16601 = opts;
var map__16601__$1 = cljs.core.__destructure_map(map__16601);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16601__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__16599);
}});
...
var temp__5802__auto___16621 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___16621)){
var managed_print_level_16623 = temp__5802__auto___16621;
var _STAR_print_level_STAR__orig_val__16603_16624 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__16604_16625 = managed_print_level_16623;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__16604_16625);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__16602_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__16602_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__16603_16624);
}} else {
job_fn();
}
