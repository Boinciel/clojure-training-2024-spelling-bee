...
var G__16531 = devtools.prefs.pref(v);
v = G__16531;
continue;
} else {
return v;
...
}catch (e16507){var _e__14993__auto__ = e16507;
return false;
}})();
...
}catch (e16510){var _e__14993__auto__ = e16510;
return false;
}})();
...
}catch (e16512){var _e__14993__auto__ = e16512;
return false;
}}
}
});
...
var vec__16516 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16516,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16516,(1),null);
...
return cljs.core.some((function (p1__16521_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16521_SHARP_);
}),template);
});
