...
var vec__25434 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
var seq__25435 = cljs.core.seq(vec__25434);
var first__25436 = cljs.core.first(seq__25435);
var seq__25435__$1 = cljs.core.next(seq__25435);
var start = first__25436;
var parts = seq__25435__$1;
...
var self__ = this;
var self__ = this;
var G__25452 = (arguments.length - (1));
switch (G__25452) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args25447){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args25447)));
}));
...
var _STAR_always_update_STAR__orig_val__25486 = reagent.impl.util._STAR_always_update_STAR_;
var _STAR_always_update_STAR__temp_val__25487 = true;
(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__temp_val__25487);

try{return (comp["forceUpdate"])();
}finally {(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__orig_val__25486);
}} else {
