...
* [`src/spelling_bee/`](src/spelling_bee/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/spelling_bee/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `spelling-bee` project root directory
